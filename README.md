...
- Design and build scalable, secure backend services in regulated environments.
- Distributed, event-driven architectures — microservices, Kafka, pub/sub.
- Cloud platforms — AWS & GCP.
- Web3 / EVM — NFT systems and smart-contract integration (ERC-20 / 721 / 1155).
- Mentor mid-level engineers, lead code reviews, and run technical interviews.
...
**Backend** — Node.js · NestJS · Express.js · Spring Boot · FastAPI

**Cloud & Infra** — AWS · GCP · Docker · Kubernetes · OpenShift

**Data** — MongoDB · MySQL · DynamoDB · Firestore · Redis · Apache Kafka

**Web3** — Web3.js · Ethereum · Polygon · Skale · Solidity · CrossMint
...
- Smart contracts and on-chain payment systems
...
[![LinkedIn](https://img.shields.io/badge/-LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/donald-anthony-chiay%C3%A9/)
[![X / Twitter](https://img.shields.io/badge/-X%20%2F%20Twitter-000000?style=for-the-badge&logo=x&logoColor=white)](https://twitter.com/DChiaye)
[![Email](https://img.shields.io/badge/-Email-D14836?style=for-the-badge&logo=maildotru&logoColor=white)](mailto:donald.anthony19@yahoo.com)
